<template>
  <section id="contact" class="py-12 md:py-16 lg:py-20 bg-gray-100">
    <div class="container w-full mx-auto px-4">
      <div
        class="bg-white rounded-2xl shadow-xl overflow-hidden w-full mx-auto"
      >
        <div class="grid grid-cols-1 lg:grid-cols-12">
          <!-- Left Side - Image -->
          <div
            class="lg:col-span-5 bg-cover bg-center hidden lg:block"
            style="background-image: url('./sud.jpg')"
          >
          ...
          <div class="p-6 sm:p-10 lg:col-span-7">
            <div class="max-w-md mx-auto">
              ...
              <h2 class="text-2xl sm:text-3xl font-bold mb-4 tracking-[2.3px]">
                <span class="text-[#0061FF]">Бесплатная</span> первичная
                консультация
              </h2>
              ...
              <form class="space-y-6" @submit.prevent="submitForm">
                ...
                <div>
                  <label
                    for="name"
                    class="block text-sm font-medium text-[#6A6A6A] mb-1"
                    >Имя</label
                  >
                  <input
                    id="name"
                ...
                <p class="text-[#7A7A7A] text-xs text-start">
                  ...
                  <a href="./conf.pdf" target="_blank" class="text-[#0061FF]"
...
const submitForm = async () => {
  ...
  try {
    ...
    if (window.ym) {
      window.ym(101465129, "reachGoal", "formsubmit", {
    ...
    alert(
      "Произошла ошибка при отправке формы. Пожалуйста, попробуйте снова позже."
    );
  } finally {
