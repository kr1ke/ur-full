...
const services = [
  {
    title: "Банкротство",
    description:
      "Осуществила более 300 банкротств общей стоимостью примерно 250 млн. рублей. Несколько сотрудников в подчинении. Опыт и команда позволяют гарантировать, что ваше дело будет проанализировано максимально детально и ваши долги будут списаны в кратчайшие сроки.",
  },
  {
