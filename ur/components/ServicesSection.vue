...
const services = [
  {
    title: "Банкротство",
    description:
      "Профессиональное сопровождение процедуры банкротства физических и юридических лиц. Полное освобождение от долгов с минимальными затратами времени и средств. Индивидуальный подход к каждому клиенту и защита от кредиторов на всех этапах процедуры.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Полное юридическое сопровождение регистрации перехода права собственности, подготовка документов любой сложности с гарантией безопасности и чистоты сделки. Проверка объектов, экспертиза договоров, отсутствие обременений и залогов. Сопровождение земельно-имущественных отношений, включая межрегиональные сделки, работу с опекой и альтернативные варианты.",
  },
  {
    title: "Наследственное право",
    description:
      "Профессиональная помощь в вопросах наследства: вступление в наследство, оформление наследства, восстановление сроков вступления в наследство, оформление прав собственности на дома, земельные участки, квартиры. Оказание помощи в приватизации и оформлении договора социального найма.",
  },
];
